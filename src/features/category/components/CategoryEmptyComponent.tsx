    ...
    <View style={styles.emptyContainer}>
      <View style={styles.iconWrapper}>
        ...
        <View style={[styles.iconContainer, isDark ? styles.iconContainerDark : styles.iconContainerLight]}>
          <Ionicons name="basket-outline" size={44} color={theme.accent} />
        </View>
      </View>
      <Text style={[styles.emptyTitle, { color: theme.text }]}>No products found</Text>
      <Text style={[styles.emptySubtitle, { color: theme.muted }]}>
        This category is currently empty. We are restocking it soon, please check back later!
      </Text>
      <Pressable
      ...
      >
        <Text style={styles.exploreButtonText}>Go Back Home</Text>
      </Pressable>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  iconContainerLight: {
    backgroundColor: "rgba(12, 162, 1, 0.08)",
  },
  iconContainerDark: {
    backgroundColor: "rgba(12, 162, 1, 0.15)",
  },
  pingRing: {
    position: "absolute",
    top: 0,
  ...
  pingRingLight: {
    backgroundColor: "rgba(12, 162, 1, 0.2)",
  },
  pingRingDark: {
